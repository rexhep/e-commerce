...
import { productByCategoryrReducer, productDetailsReducer, productListReducer, productRegisterReducer } from './reducers/productReducers';
import { productRatingsReducer } from './reducers/ratingsReducers';
...
const reducer = combineReducers({
    ...
    rateProduct: productRatingsReducer,
    categoryOfProducts: productByCategoryrReducer
});
